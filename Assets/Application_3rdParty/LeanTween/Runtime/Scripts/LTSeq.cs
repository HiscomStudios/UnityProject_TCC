...
namespace HiscomEngine.ThirdParty.LeanTween.Runtime.Scripts
{
	...
	public class LTSeq 
	{
		...
		private LTSeq addOn(){
			...
			this.current = global::LeanTween.sequence(true);
...
//		Debug.Log("delay:"+delay+" count:"+this.current.count+" this.current.totalDelay:"+this.current.totalDelay);
	...
	*/
		public LTSeq append( System.Action callback ){
			LTDescr newTween = global::LeanTween.delayedCall(0f, callback);
//		Debug.Log("newTween:" + newTween);
	...
	*/
		public LTSeq append( System.Action<object> callback, object obj ){
			append(global::LeanTween.delayedCall(0f, callback).setOnCompleteParam(obj));

			return addOn();
		}

		public LTSeq append( GameObject gameObject, System.Action callback ){
			append(global::LeanTween.delayedCall(gameObject, 0f, callback));

			return addOn();
		}

		public LTSeq append( GameObject gameObject, System.Action<object> callback, object obj ){
			append(global::LeanTween.delayedCall(gameObject, 0f, callback).setOnCompleteParam(obj));
