	...
	public class LTDescr
	{
		...
		public LTDescr cancel( GameObject gameObject ){
			...
			if(gameObject==this.trans.gameObject)
				global::LeanTween.removeTween((int)this._id, this.uniqueId);
			return this;
		}
		...
		public LTDescr setRotateX(){
			...
			this.initInternal = ()=>{ this.fromInternal.x = trans.eulerAngles.x; this.toInternal.x = global::LeanTween.closestRot( this.fromInternal.x, this.toInternal.x);};
		...
		public LTDescr setRotateY(){
			...
			this.initInternal = ()=>{ this.fromInternal.x = trans.eulerAngles.y;  this.toInternal.x = global::LeanTween.closestRot( this.fromInternal.x, this.toInternal.x);};
		...
		public LTDescr setRotateZ(){
			...
			this.initInternal = ()=>{
				...
				this.toInternal.x = global::LeanTween.closestRot( this.fromInternal.x, this.toInternal.x);
			};
		...
		public LTDescr setRotate(){
			...
			this.initInternal = ()=>{ this.from = trans.eulerAngles;  this.to = new Vector3(global::LeanTween.closestRot( this.fromInternal.x, this.toInternal.x), global::LeanTween.closestRot( this.from.y, this.to.y), global::LeanTween.closestRot( this.from.z, this.to.z)); };
			this.easeInternal = ()=>{ 
				newVect = easeMethod();
		...
		public LTDescr setRotateLocal(){
			...
			this.initInternal = ()=>{ this.from = trans.localEulerAngles;  this.to = new Vector3(global::LeanTween.closestRot( this.fromInternal.x, this.toInternal.x), global::LeanTween.closestRot( this.from.y, this.to.y), global::LeanTween.closestRot( this.from.z, this.to.z)); };
			this.easeInternal = ()=>{ 
				newVect = easeMethod();
...
//		Debug.Log ("tween:" + this+ " dt:"+dt);
	...
	*/
		...
		public LTDescr setEasePunch(){ this._optional.animationCurve = global::LeanTween.punch; this.toInternal.x = this.from.x + this.to.x; this.easeMethod = this.tweenOnCurve; return this; }

		public LTDescr setEaseShake(){ this._optional.animationCurve = global::LeanTween.shake; this.toInternal.x = this.from.x + this.to.x; this.easeMethod = this.tweenOnCurve; return this; }
...
//		val = (val * val * val * val - 2f);
		...
		private Vector3 easeInSine(){
			val = - Mathf.Cos(this.ratioPassed * global::LeanTween.PI_DIV2);
		...
		private Vector3 easeOutSine(){
			val = Mathf.Sin(this.ratioPassed * global::LeanTween.PI_DIV2);
			return new Vector3(this.diff.x * val + this.from.x, this.diff.y * val + this.from.y,this.diff.z * val + this.from.z);
		}
		...
		private Vector3 easeInBounce(){
			val = this.ratioPassed;
			val = 1f - val;
			return new Vector3(this.diff.x - global::LeanTween.easeOutBounce(0, this.diff.x, val) + this.from.x, 
				this.diff.y - global::LeanTween.easeOutBounce(0, this.diff.y, val) + this.from.y, 
				this.diff.z - global::LeanTween.easeOutBounce(0, this.diff.z, val) + this.from.z);
		}
		...
		private Vector3 easeInOutBounce(){
			val = this.ratioPassed * 2f;
			if (val < 1f){
				return new Vector3(global::LeanTween.easeInBounce(0, this.diff.x, val) * 0.5f + this.from.x, 
					global::LeanTween.easeInBounce(0, this.diff.y, val) * 0.5f + this.from.y, 
					global::LeanTween.easeInBounce(0, this.diff.z, val) * 0.5f + this.from.z);
			}else {
				val = val - 1f;
				return new Vector3(global::LeanTween.easeOutBounce(0, this.diff.x, val) * 0.5f + this.diffDiv2.x + this.from.x,
					global::LeanTween.easeOutBounce(0, this.diff.y, val) * 0.5f + this.diffDiv2.y + this.from.y,
					global::LeanTween.easeOutBounce(0, this.diff.z, val) * 0.5f + this.diffDiv2.z + this.from.z);
			}
		}
		...
		private Vector3 easeInElastic(){
			return new Vector3(global::LeanTween.easeInElastic(this.from.x,this.to.x,this.ratioPassed,this.overshoot,this.period),
				global::LeanTween.easeInElastic(this.from.y,this.to.y,this.ratioPassed,this.overshoot,this.period),
				global::LeanTween.easeInElastic(this.from.z,this.to.z,this.ratioPassed,this.overshoot,this.period));
		}		

		private Vector3 easeOutElastic(){
			return new Vector3(global::LeanTween.easeOutElastic(this.from.x,this.to.x,this.ratioPassed,this.overshoot,this.period),
				global::LeanTween.easeOutElastic(this.from.y,this.to.y,this.ratioPassed,this.overshoot,this.period),
				global::LeanTween.easeOutElastic(this.from.z,this.to.z,this.ratioPassed,this.overshoot,this.period));
		}

		private Vector3 easeInOutElastic()
		{
			return new Vector3(global::LeanTween.easeInOutElastic(this.from.x,this.to.x,this.ratioPassed,this.overshoot,this.period),
				global::LeanTween.easeInOutElastic(this.from.y,this.to.y,this.ratioPassed,this.overshoot,this.period),
				global::LeanTween.easeInOutElastic(this.from.z,this.to.z,this.ratioPassed,this.overshoot,this.period));
		}
